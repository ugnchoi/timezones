...
export function CityTimeRadialChart({ cities, instant }: CityTimeRadialChartProps) {
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-1 text-center sm:text-left">
        <CardTitle className="text-lg sm:text-xl">City Times - Radial View</CardTitle>
        <CardDescription className="text-sm text-muted-foreground sm:text-base">Current time across all cities</CardDescription>
      </CardHeader>
      <CardContent className="flex-1 p-0">
        <ChartContainer
          config={chartConfig}
          className="mx-auto aspect-square max-h-[320px] sm:max-h-[400px]"
        >
          <RadialBarChart
            data={chartData}
            startAngle={-90}
      ...
      <CardContent className="flex-col gap-2 pt-1 pb-2 text-sm">
