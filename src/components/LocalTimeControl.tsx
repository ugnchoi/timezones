    ...
    return (
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
        <input
          ...
          onBlur={handleBlur}
          className="font-mono tabular-nums text-3xl sm:text-4xl md:text-5xl font-semibold bg-transparent border-none outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 rounded px-2 py-1 w-28 text-center"
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
      <button
        onClick={handleClick}
        className={cn(
          "font-mono tabular-nums text-3xl sm:text-4xl md:text-5xl font-semibold hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded transition-colors",
